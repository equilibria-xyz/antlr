...
usingForDeclaration
  : 'using' userDefinedTypeName 'for' ('*' | typeName) GlobalKeyword? ';' ;
...
identifier
  : ('from' | 'calldata' | 'receive' | 'callback' | 'revert' | 'error' | GlobalKeyword | ConstructorKeyword | PayableKeyword | LeaveKeyword | Identifier) ;
